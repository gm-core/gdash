...
var test1 = _difference_by(arr1, arr2, _floor);
var test2 = _difference_by(arr1, arr3, _floor);
var test3 = _difference_by(arr1, arr2, arr3, _floor);
var test4 = _difference_by(arr3, arr1, _floor);
